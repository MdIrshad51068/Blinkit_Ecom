...
const Footer = () => {
  return (
    <footer className="border-t border-t-gray-200 py-8 bg-[#f2f2f2]">
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between items-center">
          <div className="mb-4 md:mb-0">
            <h2 className="text-xl font-bold">take<span className='text-[#00802b]'>it</span></h2>
            <p className="text-sm"> Belive it and take from it</p>
          </div>
